...
public class  AmazonDSPBudgetPacingTest extends BaseClass {
    ...
    public void setupTests(ITestContext testContext) throws Exception {
        ...
        netNewNavigationMenu.selectBU("Clorox");
        ...
        budgetManagerPage.selectSinglePlatform("Amazon","Walmart","Instacart","Criteo");
    ...
    public void Budget_Setting_Model_Daily_Test() throws InterruptedException {
        ...
        LOGGER.info("Remove the Pacing method to 'None' ");
